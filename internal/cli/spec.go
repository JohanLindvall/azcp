...
var specs = []cpflags.Spec{
	...
	{Long: "backup", Arg: cpflags.OptionalArg, Meta: "CONTROL",
		Help: "make a backup of each existing destination file"},
	{Short: 'b', Arg: cpflags.NoArg,
		Help: "like --backup but does not accept an argument"},
	{Long: "copy-contents", Arg: cpflags.NoArg,
		Help: "copy contents of special files when recursive"},
	{Long: "debug", Arg: cpflags.NoArg,
		Help: "like --verbose, with how each file was copied in the log output"},
	...
	{Long: "update", Arg: cpflags.OptionalArg, Meta: "UPDATE",
		Help: "control which existing files are replaced: all, none, none-fail, older"},
	{Short: 'u', Arg: cpflags.NoArg,
